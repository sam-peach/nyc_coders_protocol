...
class TestServer(unittest.TestCase):
    @patch("server.apple")
    @patch("socket.socket")
    def test_serve_client_00_byte(self, mock_socket, mock_apple):
    ...
    @patch("server.banana")
    @patch("socket.socket")
    def test_serve_client_01_byte(self, mock_socket, mock_banana):
        client_socket = MagicMock()
    ...
    @patch("server.mango")
    @patch("socket.socket")
    def test_serve_client_02_byte(self, mock_socket, mock_mango):
        client_socket = MagicMock()
